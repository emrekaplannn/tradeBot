...
SYMBOL4 = "XRPUSDT"
SYMBOL5 = "DOGEUSDT"
INTERVAL = "30m"  # 1-minute candles for live trading
SL_PERCENT = 0.1  # Stop-loss percentage (3.5%)
TP_PERCENT = 0.012  # Take-profit percentage (1.8%)
MOVE_SL_TRIGGER = 0.008  # Move SL when price goes 1% above entry price
